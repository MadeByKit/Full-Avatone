...
def create_root(start: Callable[[], None], destroy: Callable[[], None]) -> ctk.CTk:
    ...
    start_button = ctk.CTkButton(root, text='Start face swap', cursor='hand2', command=lambda: select_output_path(start))
    start_button.place(relx=0.15, rely=0.80, relwidth=0.2, relheight=0.05)

    live_button = ctk.CTkButton(root, text='Start Video Call', cursor='hand2', command=lambda: webcam_preview())
    live_button.place(relx=0.60, rely=0.80, relwidth=0.2, relheight=0.05)
